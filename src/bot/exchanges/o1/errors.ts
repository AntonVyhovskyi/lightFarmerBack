...
export const normalizeO1Error = (err: unknown): O1Result<never> => {
  ...
  o1Error("O1_ERROR_NORMALIZED", "Normalized exchange error.", { reason, suggestion, rawError: raw });
  return { ok: false, reason, suggestion, rawError: raw };
};
